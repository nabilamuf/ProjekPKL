<?php 
    $qb = new lsp();
    $dataB = $qb->selek("pmn_Roda2","id_pmg_pribadi",$_SESSION['kd_user']);
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="Pegawai/pemeliharaan/expmnroda2.php" button type="submit" data-toggle="tooltip" style="margin-left: 400px;" data-placement="top" name="excel" class="btn btn-info ds"><i class="fa fa-download ds"> Unduh Excel</a></i>   
                           </button>
                           <br>
                           <br>
