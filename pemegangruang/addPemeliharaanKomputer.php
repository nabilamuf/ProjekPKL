<?php 
    ...
    $autokode = $br->autokode($table, "id_pmn_komputer", "PMNKOM");
    // $waktu    = date("Y-m-d");
        ...
        if ( $id_pmn_komputer == " " || $tanggal == " " || $no_SPPK == " " || $service == " " || $penggantian == " " ||$ket_alat_ganti == " " || $nama_bengkel == " " || $besar_biaya == " " || $gambar_service == " " || $slip_bukti == " " || $id_komputer == " " || $id_pmg_pribadi == " " ) {
            $response = ['response'=>'negative','alert'=>'lengkapi field'];
                ...
                if ($response['types'] == "true") {
                    $value = "'','$id_pmn_komputer','$tanggal','$no_SPPK','$service','$penggantian','$ket_alat_ganti','$nama_bengkel','$besar_biaya','$response[image]','$response1[image1]','$id_komputer','$id_pmg_pribadi'";
                    $response = $br->insert($table,$value,"?page=addPemeliharaanKomputer");
			    }
            } 
        }
 ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="">Id Pemeliharaan Komputer</label>
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control" name="id_pmn_komputer" readonly value="<?= $autokode; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ket_alat_ganti">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="id_komputer">
                                </div>
                                <div class="form-group">
