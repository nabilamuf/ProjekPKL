<?php 
	$dt = new lsp();
	$detail = $dt->selectWhere("pmn_genset","id_pem_genset",$_GET['id']);
            	...
            	<div class="col-md-4">
            		<div class="card">
            			<div class="card-header">
            				...
            				<h4 class="text-right"><?= $detail['id_pem_genset'] ?></h4>
            			</div>
            			<div class="card-body">
            	...
            	<div class="col-md-8">
            		<div class="card">
            			...
            			<div class="card-body">
	    					...
	    					<tr>
	    						<td>Id Pemegang Genset</td>
	    						<td>:</td>
	    						<td style="font-weight: bold; color: red;"><?php echo $detail['id_pem_genset']; ?></td>
	    					</tr>
	    					<tr>
	    						<td>Tanggal</td>
	    						<td>:</td>
