<?php 
    ...
    if($lg->sessionCheck() == "true"){
        if($_SESSION['level'] == "Admin"){
            ...
            header("location:pageAtasan.php");
        }else if($_SESSION['level'] == "Pegawai"){
            header("location:pagePegawai.php");
        }else if($_SESSION['level'] == "Pemegang Ruang"){
        header("location:pagePemegangRuang.php");
     }
    }
        ...
        if ($response = $lg->login($username, $password)) {
            if ($response['response'] == "positive") {
                ...
                if ($response['level'] == "Admin") {
                    ...
                    $response = $lg->redirect("pageAtasan.php");
                }else if ($response['level'] == "Pegawai") {
                    $response = $lg->redirect("pagePegawai.php");
                }else if ($response['level'] == "Pemegang Ruang") {
                    $response = $lg->redirect("pagePemegangRuang.php");
                }
            }
        }
    }
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/bps.png" alt="CoolAdmin">
                            </a>
                        </div>
