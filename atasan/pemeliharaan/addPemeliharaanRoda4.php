<?php 
    ...
    $autokode = $br->autokode($table, "id_pem_roda4", "PMNRD4");
    // $waktu    = date("Y-m-d");
    if (isset($_POST['getSimpan'])) {
        ...
        if ($id_pem_roda4 == " " || $tanggal == " " || $no_sppk == " " || $service == " " || $penggantian == " " ||$ket_alat_ganti == " " || $tgl_msk_bengkel == " " || $tgl_klr_bengkel == " " || $nama_bengkel == " " || $besar_biaya == " " || $gambar_service == " " || $slip_bukti == " " || $id_roda4 == " " || $id_pmg_pribadi == " " ) {
            $response = ['response'=>'negative','alert'=>'lengkapi field'];
                ...
                if ($response['types'] == "true") {
                    $value = "'','$id_pem_roda4','$tanggal','$no_sppk','$service','$penggantian','$ket_alat_ganti','$tgl_msk_bengkel','$tgl_klr_bengkel','$nama_bengkel','$besar_biaya','$response[image]','$response1[image1]','$id_roda4','$id_pmg_pribadi'";
                    $response = $br->insert($table,$value,"?page=viewPemeliharaanRoda4");
			    }
            } 
        }
 ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="">Id Pemegang Roda Empat</label>
                                    <input type="text" class="form-control" name="id_pem_roda4" readonly value="<?= $autokode; ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="">Id Roda Empat</label>
                                    <input type="text" class="form-control" name="id_roda4">
                                </div>
                                <div class="form-group">
                                    <label for="">Id Pemegang pribadi</label>
