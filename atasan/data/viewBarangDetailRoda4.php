<?php 
	$dt = new lsp();
	$detail = $dt->selectWhere("data_roda4","id_roda4",$_GET['id']);
            	...
            	<div class="col-md-4">
            		<div class="card">
            			<div class="card-header">
            				...
            				<h4 class="text-right"><?= $detail['id_roda4'] ?></h4>
            			</div>
            			<div class="card-body">
            		...
            		<div class="card">
            			...
            			<div class="card-body">
	    					...
	    					<tr>
	    						<td>Kode Roda 4</td>
	    						<td>:</td>
	    						<td style="font-weight: bold; color: red;"><?php echo $detail['id_roda4']; ?></td>
	    					</tr>
	    					<tr>
	    						<td>Merek</td>
	    						<td>:</td>
							...
							<tr>
	    						<td>Pengguna</td>
	    						<td>:</td>
	    						<td><?php echo $detail['pengguna'] ?></td>
	    					</tr>
							<tr>
