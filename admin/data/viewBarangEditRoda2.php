<?php 
	...
	$table    = "data_roda2";
	$data     = $br->selectWhere($table,"id_roda2",$_GET['id']);
	if (isset($_POST['getSimpan'])) {
		...
		if ($id_roda2 == " " || $merk == " " || $type == " " || $th_pembuatan == " " || $pabrik == " " || $foto == " "|| $negara== " ") {
			$response = ['response'=>'negative','alert'=>'lengkapi field'];
		}else{
					$response = $br->validateImage();
					$image = $response['image'];
					if ($response['types'] == "true") {	
						$value = "no='',id_roda2='$id_roda2',merk='$merk',type='$type',th_pembuatan='$th_pembuatan',pabrik='$pabrik',negara='$negara',perakitan='$perakitan',
						...
						$response = $br->update($table,$value,"id_roda2",$_GET['id'],"?page=viewRoda2");
					}else{
            			...
            			<div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control" name="id_roda2" value="<?php echo @$data['id_roda2'] ?>">
                                </div>
