<?php 
	...
	$table    = "data_komputer";
	$data     = $br->selectWhere($table,"id_komputer",$_GET['id']);
	if (isset($_POST['getSimpan'])) {
		...
		if ($id_komputer == " " || $no_urut_pendaftar == " "||$merk == " " || $th_perolehan == " " || $jumlah_barang == " " || $penguasaan == " " || $foto == " " || $ket == " " || $kd_user == " " ) {
			$response = ['response'=>'negative','alert'=>'lengkapi field'];
		}else{
					$response = $br->validateImage();
					$image = $response['image'];
					if ($response['types'] == "true") {	
						$value = "no='',id_komputer='$id_komputer',no_urut_pendaftar='$no_urut_pendaftar',merk='$merk',th_perolehan='$th_perolehan',jumlah_barang='$jumlah_barang',penguasaan='$penguasaan',
						gambar='$image',keterangan='$ket',kd_user='$kd_user'";
						$response = $br->update($table,$value,"id_komputer",$_GET['id'],"?page=viewKomputer");
					}else{
            			...
            			<div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control" name="id_komputer" value="<?php echo @$data['id_komputer']; ?>">
                                </div>
                                <div class="form-group">
                        	...
                        	<div class="card-footer">
                        		...
                        		<a href="?page=viewKomputer" class="btn btn-danger"><i class="fa fa-repeat"></i> Kembali</a>
                        	</div>
            			</div>
            		</form>
            	</div>
