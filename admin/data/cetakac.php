<?php 
	$struk  		= new lsp();
	$id				= $_GET['id'];
	$data   		= $struk->edit("data_ac","id_ac",$id);
    $detail = $struk->selectWhere("data_ac", "id_ac", $_GET['id']); 
 ?>
 <style>
 	.col-sm-8{
 		background: white;
	...
	<div class="section__content section__content--p30">
	<h7 style="font-family: times-new-rowman; font-size: 12pt"> Badan Pusat Statistik &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;  &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; <?php echo "   A. Kode Barang 	: ".$detail['id_ac'];  ?></h7> <br>
            	...
            	<div class="col-md-12">
            		<div class="card">
            			...
            			<div class="card-body">
								...
								<tr>
                                    <th colspan="2"><h5 align="center"><?php echo "DATA AC"?></h5></th>
								</tr>
                                <tr><td colspan="2">
									&emsp;1. ID AC <span style="padding-left:200px;">: <?php echo $detail['id_ac']; ?></span>	
					            </td></tr>
                                <tr><td colspan="2">
                                ...
                                <tr><td colspan="2">
									&emsp;8. Keterangan<span style="padding-left:141px;">: <?php echo $detail['ket']; ?></span>	
					            </td></tr>
                                <tr><td colspan="2">
