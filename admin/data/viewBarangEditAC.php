<?php 
	...
	$table    = "data_ac";
	$data     = $br->selectWhere($table,"id_ac",$_GET['id']);
	if (isset($_POST['getSimpan'])) {
		...
		if ($id_ac == " " || $no_urut_pendaftar == " " || $merk == " " || $th_perolehan == " " || $jumlah_barang == " " || $penguasaan == " " ||
		$foto == " " || $ket == " " || $kd_user == " " ) {
			$response = ['response'=>'negative','alert'=>'lengkapi field'];
					...
					if ($response['types'] == "true") {	
						$value = "no='',id_ac='$id_ac',no_urut_pendaftar='$no_urut_pendaftar', merk='$merk',th_perolehan='$th_perolehan',
						jumlah_barang='$jumlah_barang',penguasaan='$penguasaan',gambar='$image',ket='$ket',kd_user='$kd_user'";
						$response = $br->update($table,$value,"id_ac",$_GET['id'],"?page=viewAC");
					}else{
            			...
            			<div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control" name="id_ac" value="<?php echo @$data['id_ac']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" rows="5" class="form-control" name="ket" ><?php echo @$data['ket'] ?></textarea>
                                </div>
