<?php 
	$struk  		= new lsp();
	$id				= $_GET['id'];
	$data   		= $struk->edit("data_komputer","id_komputer",$id);
    $detail = $struk->selectWhere("data_komputer", "id_komputer", $_GET['id']); 
 ?>
 <style>
 	.col-sm-8{
 		background: white;
	...
	<div class="section__content section__content--p30">
	<h7 style="font-family: times-new-rowman; font-size: 12pt"> Badan Pusat Statistik &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;  &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; <?php echo "   A. Kode Barang 	: ".$detail['id_komputer'];  ?></h7> <br>
            	...
            	<div class="col-md-12">
            		<div class="card">
            			...
            			<div class="card-body">
								...
								<tr>
                                    <th colspan="2"><h5 align="center"><?php echo "DATA komputer"?></h5></th>
								</tr>
                                <tr><td colspan="2">
									&emsp;1. ID komputer <span style="padding-left:145px;">: <?php echo $detail['id_komputer']; ?></span>	
					            </td></tr>
                                <tr><td colspan="2">
