<?php 
    ...
    if (isset($_POST['getSimpan'])) {
        ...
        if ($id_roda2 == " " || $merk == " " || $type == " ") {
            $response = ['response'=>'negative','alert'=>'lengkapi field'];
        }else{
                $response = $br->validateImage($foto);
                $image = $response['image']; 
                if ($response['types'] == "true") {
                    $value = "'$no', '$id_roda2', '$merk', '$type', '$th_pembuatan', '$pabrik', '$negara', '$perakitan', '$daya_muat', '$bobot', '$daya_isi_silinder',
                    ...
                    $response = $br->insert($table,$value,"?page=viewroda2");
                }
            } 
        }
 ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control" name="id_roda2">
                                </div>
