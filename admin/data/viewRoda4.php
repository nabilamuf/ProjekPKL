<?php 
    $qb = new lsp();
    $dataB = $qb->select("data_roda4");
    if ($_SESSION['level'] != "Admin") {
    header("location:../index.php");
    }
    if (isset($_GET['delete'])) {
        $response = $qb->delete("data_roda4","id_roda4",$_GET['id'],"?page=viewRoda4");
    }
 ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="?page=addBarangRoda4" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Roda 4</a>
                           </button>
                           <br>
                           <br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="?page=viewBarangDetailRoda4&id=<?php echo $ds['id_roda4'] ?>" data-toggle="tooltip" data-placement="top" title="Detail" class="btn btn-warning"><i class="fa fa-search"></i></a>
                                                    <a href="?page=viewBarangEditRoda4&edit&id=<?= $ds['id_roda4'] ?>" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <a href="?page=strukTransaksib&id=<?php echo $ds['id_roda4'] ?>" class="btn btn-info ds"   ><i class="fa fa-print" ></i> Cetak Struk</a></span>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <script>
                                            $('#btdelete<?php echo $no; ?>').click(function(e){
                                                  e.preventDefault();
                                                    ...
                                                    if (isConfirm) {
                                                        window.location.href="?page=viewRoda4&delete&id=<?php echo $ds['id_roda4'] ?>";
                                                    }
                                                  });
                                                });
                                        </script>
