            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="?page=addBarangRoda2" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah roda 2</a>
                           </button>
                           <br>
                           <br>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="?page=viewBarangEditRoda2&edit&id=<?= $ds['id_roda2'] ?>" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
