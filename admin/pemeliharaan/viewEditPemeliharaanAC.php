<?php 
	...
	//	$slip_bukti		= $_POST['slip_bukti'];
		...
		if ($no == " " || $id_pem_ac == " " || $tanggal == " " || $no_SPPK == " " || $service == " " || $penggantian == " " || $ket_alat_ganti == " " || $nama_bengkel == " " || $besar_biaya == " " || $gambar_service == " " || $slip_bukti == " " || $id_ac == " " || $id_pmg_ruang == " " ) {
			...
			if ($response['types'] == "true") {
				$value = "no='',id_pem_ac='$id_pem_ac',tanggal='$tanggal',no_SPPK='$no_SPPK',service='$service',penggantian='$penggantian',ket_alat_ganti='$ket_alat_ganti',nama_bengkel='$nama_bengkel',besar_biaya='$besar_biaya',gambar_service='$image',slip_bukti='$image1',id_ac='$id_ac',id_pmg_ruang='$id_pmg_ruang'";
				$response = $br->update($table,$value,"id_pem_ac",$_GET['id'],"?page=viewPemeliharaanAC");
			}else{
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control" name="id_pem_ac" value="<?php echo @$data['id_pem_ac'] ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="id_ac" value="<?php echo $data['id_ac']; ?>">
                                </div>
                                <div class="form-group">
                        	...
                        	<div class="card-footer">
                        		...
                        		<a href="?page=viewPemeliharaanAC" class="btn btn-danger"><i class="fa fa-repeat"></i> Kembali</a>
                        	</div>
            			</div>
            		</form>
            	</div>
