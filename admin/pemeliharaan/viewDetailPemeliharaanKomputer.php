<?php 
	$dt = new lsp();
	$detail = $dt->selectWhere("pmn_komputer","id_pmn_komputer",$_GET['id']);
        ...
        <div class="container-fluid">
            <div class="row">
            	<div class="col-md-4">
            		<div class="card">
            			<div class="card-header">
            				...
            				<h4 class="text-right"><?= $detail['id_pmn_komputer'] ?></h4>
            			</div>
            			<div class="card-body">
            	...
            	<div class="col-md-8">
            		<div class="card">
            			<div class="card-header">
            				<h3>Detail Komputer</h3>
            			</div>
            			<div class="card-body">
            				<table class="table" cellpadding="10">
						
	    					<tr>
	    						<td>Id Pemeliharaan Komputer</td>
	    						<td>:</td>
	    						<td style="font-weight: bold; color: red;"><?php echo $detail['id_pmn_komputer']; ?></td>
	    					</tr>
	    					<tr>
	    						<td>Tanggal</td>
	    						<td>:</td>
							...
							<tr>
	    						...
	    						<td>Id Komputer</td>
	    						<td>:</td>
	    						<td><?php echo $detail['id_komputer']; ?></td>
	    					</tr>
							<tr>
            ...
            <a href="?page=viewPemeliharaanKomputer" class="btn btn-danger"><i class="fa fa-repeat"></i> Kembali</a>
        </div>
    </div>
</div>