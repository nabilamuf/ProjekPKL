<?php 
	$dt = new lsp();
	$detail = $dt->selectWhere("pmn_roda4","id_pem_roda4",$_GET['id']);
        ...
        <div class="container-fluid">
            <div class="row">
            	<div class="col-md-4">
            		<div class="card">
            			<div class="card-header">
            				...
            				<h4 class="text-right"><?= $detail['id_pem_roda4'] ?></h4>
            			</div>
            			<div class="card-body">
            	...
            	<div class="col-md-8">
            		<div class="card">
            			<div class="card-header">
            				<h3>Detail Roda Empat</h3>
            			</div>
            			<div class="card-body">
            				<table class="table" cellpadding="10">
						
	    					<tr>
	    						<td>Id Pemeliharaan Roda Empat</td>
	    						<td>:</td>
	    						<td style="font-weight: bold; color: red;"><?php echo $detail['id_pem_roda4']; ?></td>
	    					</tr>
	    					<tr>
	    						<td>Tanggal</td>
	    						<td>:</td>
							...
							<tr>
	    						...
	    						<td>Id Roda Dua</td>
	    						<td>:</td>
	    						<td><?php echo $detail['id_roda4']; ?></td>
	    					</tr>
							<tr>
