<?php 
	...
	$table    = "pmn_roda4";
	$data     = $br->selectWhere($table,"id_pem_roda4",$_GET['id']);

	if (isset($_POST['getSimpan'])) {
		
		$id_pem_roda4		= $_POST['id_pem_roda4'];
	...
	//	$slip_bukti		= $_POST['slip_bukti'];
		...
		if ($no == " " || $id_pem_roda4 == " " || $tanggal == " " || $no_sppk == " " || $service == " " || $penggantian == " " || $ket_alat_ganti == " " || $tgl_msk_bengkel == " " || $tgl_klr_bengkel == " " || $nama_bengkel == " " || $besar_biaya == " " || $gambar_service == " " || $slip_bukti == " " || $id_roda4 == " " || $id_pmg_pribadi == " " ) {
			...
			if ($response['types'] == "true") {
				$value = "no='',id_pem_roda4='$id_pem_roda4',tanggal='$tanggal',no_sppk='$no_sppk',service='$service',penggantian='$penggantian',ket_alat_ganti='$ket_alat_ganti',tgl_msk_bengkel='$tgl_msk_bengkel',tgl_klr_bengkel='$tgl_klr_bengkel',nama_bengkel='$nama_bengkel',besar_biaya='$besar_biaya',gambar_service='$image',slip_bukti='$image1',id_roda4='$id_roda4',id_pmg_pribadi='$id_pmg_pribadi'";
				$response = $br->update($table,$value,"id_pem_roda4",$_GET['id'],"?page=viewPemeliharaanRoda4");
			}else{
            		...
            		<form method="post" enctype="multipart/form-data">
            			<div class="card">
            				<div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
	                            ...
	                            <h3>
	                            <i class="zmdi zmdi-account-calendar"></i>Pemeliharaan Roda Empat</h3>
                        	</div>
							<div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="">Id Pemegang Roda 4</label>
                                    <input type="text"  style="font-weight: bold; color: red;" class="form-control" name="id_pem_roda4" readonly value="<?php echo @$data['id_pem_roda4'] ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="">Id Roda 4</label>
                                    <input type="text" class="form-control" name="id_roda4" value="<?php echo $data['id_roda4'] ?>">
                                </div>
                                <div class="form-group">
                        	...
                        	<div class="card-footer">
                        		...
                        		<a href="?page=viewpemeliharaanRoda4" class="btn btn-danger"><i class="fa fa-repeat"></i> Kembali</a>
                        	</div>
            			</div>
            		</form>
            	</div>
